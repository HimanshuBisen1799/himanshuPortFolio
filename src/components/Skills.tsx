...
import { Database, Globe, Server, Code, Braces, Laptop, GitBranch, Users } from 'lucide-react';
  ...
  const skills = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Java SE", level: 75, icon: <Code className="w-4 h-4" /> },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "SQL", level: 80, icon: <Database className="w-4 h-4" /> },
